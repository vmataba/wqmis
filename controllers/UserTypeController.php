...
class UserTypeController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            \Yii::$app->session->setFlash('success', "{$model->user_type_description} has been successdully created");
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
              \Yii::$app->session->setFlash('success', "{$model->user_type_description} has been successdully updated");
            return $this->redirect(['index']);
        }
